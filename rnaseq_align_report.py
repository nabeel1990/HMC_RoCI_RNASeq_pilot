...
def make_rnw_html(rnw_template, project_name, path_start, sample_names, ref_genome, library_type, aligner):
    """
...
def main(project_name, sample_info_file, path_start, aligner):
    ...
    sample_paths = map(lambda x: path_start+x[1]+"/"+x[2]+"/", runs)
    ...
    make_rnw_html(rnw_template, project_name, new_dir, sample_names, ref_genome, library_type, aligner)
...
if __name__ == "__main__":
    ...
    main(args.project_name, args.samples_in, args.path_start,args.alignment_tool)
